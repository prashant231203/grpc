...
const (
	...
	GreetService_BiDirectionalStreaming_FullMethodName  = "/greet_service.GreetService/BiDirectionalStreaming"
...
type GreetServiceClient interface {
	...
	ServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error)
	// Client-side streaming RPC
	ClientStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MessageList], error)
...
func (c *greetServiceClient) ServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], GreetService_ServerStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type GreetService_ServerStreamingClient = grpc.ServerStreamingClient[HelloResponse]

func (c *greetServiceClient) ClientStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MessageList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], GreetService_ClientStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_ClientStreamingClient = grpc.ClientStreamingClient[HelloRequest, MessageList]

func (c *greetServiceClient) BiDirectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_BiDirectionalStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_BiDirectionalStreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[3], GreetService_SayHelloServerStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[NameList, HelloResponse]{ClientStream: stream}
...
type GreetServiceServer interface {
	...
	// Server-side streaming RPC
	ServerStreaming(*NameList, grpc.ServerStreamingServer[HelloResponse]) error
	// Client-side streaming RPC
	ClientStreaming(grpc.ClientStreamingServer[HelloRequest, MessageList]) error
	// Bi-directional streaming RPC
...
func (UnimplementedGreetServiceServer) ServerStreaming(*NameList, grpc.ServerStreamingServer[HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method ServerStreaming not implemented")
}
func (UnimplementedGreetServiceServer) ClientStreaming(grpc.ClientStreamingServer[HelloRequest, MessageList]) error {
	return status.Errorf(codes.Unimplemented, "method ClientStreaming not implemented")
}
func (UnimplementedGreetServiceServer) BiDirectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
...
func _GreetService_ServerStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).ServerStreaming(m, &grpc.GenericServerStream[NameList, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_ServerStreamingServer = grpc.ServerStreamingServer[HelloResponse]

func _GreetService_ClientStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).ClientStreaming(&grpc.GenericServerStream[HelloRequest, MessageList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_ClientStreamingServer = grpc.ClientStreamingServer[HelloRequest, MessageList]

func _GreetService_BiDirectionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).BiDirectionalStreaming(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_BiDirectionalStreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
